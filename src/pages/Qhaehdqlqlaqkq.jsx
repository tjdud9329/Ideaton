  ...
  return (
    <div className="flex flex-col min-h-screen bg-white pb-20 overflow-y-auto">
      ...
      <div className="relative w-full h-[300px]">
        ...
        <button
          onClick={() => navigate(-1)}
          className="absolute top-[50px] left-[16gipx] w-8 h-8 bg-white/80 rounded-full flex items-center justify-center shadow-md"
        >
          ←
        </button>
      </div>
      ...
      <div className="px-[24px] pt-[24px]">
        <h1 className="text-[20px] font-bold text-black mb-[8px]">
          봄동 비빔밥
        </h1>
        <p className="text-[12px] text-[#A3A3A3] mb-[20px]">
          아삭한 봄동과 매콤달콤한 고추장 소스의 환상적인 조화!
        </p>

        {/* 탭 메뉴 */}
        <div className="flex bg-[#F4F4F4] rounded-lg p-1 mb-[16px]">
          <button className="flex-1 py-2 bg-white rounded-md shadow-sm font-bold text-[14px]">
            필요한 재료
          </button>
          <button className="flex-1 py-2 text-[#A3A3A3] text-[14px]">
            조리 방법
          </button>
        </div>
